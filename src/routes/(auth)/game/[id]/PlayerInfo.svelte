...
<div class="mb-4 flex items-center justify-between">
    ...
    <div class="flex gap-4 text-sm">
        <div class="flex items-center gap-2">
            <span
                class="{player1_presence
                    ? 'text-green-400'
                    : 'text-gray-500'} {current_player_symbol === 'X'
                    ? 'rounded px-2 py-1 font-bold ring-2 ring-blue-400'
                    : ''}"
            >
        ...
        <div class="flex items-center gap-2">
            <span
                class="{player2_presence
                    ? 'text-green-400'
                    : 'text-gray-500'} {current_player_symbol === 'O'
                    ? 'rounded px-2 py-1 font-bold ring-2 ring-red-400'
                    : ''}"
            >
...
{#if current_player_symbol && is_player_turn}
    <div class="mb-4 rounded border border-green-500 bg-green-900/30 p-3 text-center font-bold">
...
{:else if current_player_symbol && !is_player_turn}
    <div class="mb-4 rounded border border-gray-600 bg-gray-800 p-3 text-center text-gray-400">
